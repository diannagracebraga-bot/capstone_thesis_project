        ...
        <div class="table-container">
            <div class="aligned">
                <div class="searchbar-container">
                    <form method="GET" action="admin_user_management.php">
                        <input type="text" placeholder=" Search "name="search" value="<?php echo htmlspecialchars($_GET['search'] ?? ''); ?>" >
                        <input type="hidden" name="page" value="users" >
                        <button type="submit">Search</button>
                        <?php if (!empty($_GET['search'])): ?>
                            <a href="admin_user_management.php" class="btn btn-secondary btn-sm"> Clear </a>
                        <?php endif; ?>
                    </form>
                </div>
                <div class="dropdown add-user-dropdown">
                    <select class="dropbtn" onchange="if(this.value) window.location.href=this.value;">
                        ...
                        <option value="admin_user_management.php?page=add_customer">
                            Customer
                        </option>
                    </select>
                </div>
            ...
            <table class="table table-secondary table-hover">
                ...
                $sql = "
                    ...
                    WHERE 
                        CONCAT_WS(' ', c.f_name, c.m_name, c.l_name) LIKE '%$search%'
                        OR u.email LIKE '%$search%'
                        OR 'Customer' LIKE '%$search%'
                        OR c.connection_status LIKE '%$search%'
                    UNION ALL
                    SELECT 
